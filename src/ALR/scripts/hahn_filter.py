    ...
    def hahn_moments(self):
        ...
        def hahn_polynomial_m(j,i):
            ...
            if j == 0:
                ...
                F = (j*(j-1)/sqrt((a+c+j) * (a+c+j-1) * (b-a-j+1) * (b-a-j) * (b-c-j+1) * (b-c-j)))
            ...
            for n in range(N_MAX):
                ...
                while s <= b-1:
                    while t <= b-1:
                        ...
                        sum_1 = sum_1 + hahn_polynomial_m(m,s) * hahn_polynomial_n(n,(a-b+t)) * px[s,t] #* im.getpixel(s,t)
                        t += 1
                    s += 1
...
if(__name__ == '__main__'):
    HahnFilter('data/AVLetters2_imgs/sp1_A1/1.jpg').hahn_moments()