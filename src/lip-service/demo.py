...
def load_video(file):
    ...
    fa = face_alignment.FaceAlignment(face_alignment.LandmarksType._2D, flip_input=False, device ='cpu') #device='cuda')
...
if(__name__ == '__main__'):
    ...
    if(hasattr(opt, 'weights')):
        pretrained_dict = torch.load(opt.weights, map_location ='cpu')
